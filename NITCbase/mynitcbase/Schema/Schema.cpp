...
int Schema::closeRel(char relName[ATTR_SIZE]) {
  if (strcmp(relName,"RELATIONCAT")==0 || strcmp(relName,"ATTRIBUTECAT")==0/* relation is relation catalog or attribute catalog */) {
...
int Schema::renameRel(char oldRelName[ATTR_SIZE], char newRelName[ATTR_SIZE]) {
    ...
    //    return E_RELOPEN
    int id = OpenRelTable::getRelId(oldRelName);
    if(id!=E_RELNOTOPEN){
      return E_RELOPEN;
    }
